...
function finishWelcome(){
    ...
    /*
       Mark Welcome as seen permanently
       for this account/browser.
    */
...
function sendMessage(event){
    ...
    /*
       Start the 15-second timer ONLY
       on the first subscriber message.
    */
...
/*
   If user refreshes while logged in:

   - If Welcome has already been completed:
     stay on Home.
   - If Welcome has not been completed:
     show Welcome.
*/
